...
#define SEL_TSS0	0x38	/* first task state segment */
#define SEL_TSS1	0x40	/* second task state segment */
#define SEL_TSS_DUMMY0	0x48	/* task(dummy0) state segment */
#define SEL_TSS_DUMMY1	0x50	/* task(dummy1) state segment */
...
/* mem pool -----------------------------------------------------------------*/
#define MEM_START	0x100000	/* user memory spool start */
...
klib.s		0x38/0x40 (TSS_SEL) are used.
